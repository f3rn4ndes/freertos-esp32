...
void BLEHandler::initBLE(const std::string &deviceName)
{
    ...
    xTaskCreate(handleReceivedData, "handleReceivedData", kBLEHandlerStackDepthSize, this, 1, nullptr);
    xTaskCreate(handleSendingData, "handleSendingData", kBLEHandlerStackDepthSize, this, 1, nullptr);
    xTaskCreate(handleDisconnection, "handleDisconnection", kBLEHandlerStackDepthSize, this, 1, nullptr);
}
